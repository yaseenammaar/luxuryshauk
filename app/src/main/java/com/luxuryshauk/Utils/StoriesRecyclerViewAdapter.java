...
//    private long t2 = 0;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        try {
            Log.d(TAG, "onBindViewHolder: user model = " + user.toString());
...
//                                                    }
                                                    ...
                                                    {
                                                        user_id = mMasterStoriesArray.getJSONObject(position).getJSONObject(mContext.getString(R.string.user_account_settings))
                                                                .get(mContext.getString(R.string.field_user_id)).toString();
