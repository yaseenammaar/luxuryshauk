...
public class CameraFrag extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.camerafragment_activity_main, container, false);
        cameraSwitchView = view.findViewById(R.id.front_back_camera_switcher);

        settingsView = view.findViewById(R.id.settings_view);
        flashSwitchView = view.findViewById((R.id.flash_switch_view));
        recordButton = view.findViewById(R.id.record_button);
        mediaActionSwitchView = view.findViewById(R.id.photo_video_camera_switcher);

        recordDurationText = view.findViewById(R.id.record_duration_text);
        recordSizeText = view.findViewById(R.id.record_size_mb_text);
